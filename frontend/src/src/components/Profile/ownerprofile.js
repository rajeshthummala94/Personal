...
handleChange = (e) => {
    ...
    if (name === "ProfileImage") {
        ...
        axios.defaults.withCredentials = true;
        axios.post('http://localhost:3001/profile/upload-file', data)
        .then(response => {
            if (response.status === 200) {
...
submitProfile=(details)=>{
    console.log("Inside profile update",details);
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.put('http://localhost:3001/profile/updateprofile',data)
            .then(response => {
                console.log("inside success" )
                console.log("Status Code : ",response.status);
                if(response.status === 200){
...
submitRestaurant=(details)=>{
  console.log("Inside restaurant submit",details);
        ...
        axios.defaults.withCredentials = true;
        //make a post request with the user data
        axios.put('http://localhost:3001/restaurant/updaterestdetails',data)
            .then(response => {
                console.log("inside success" )
                console.log("Status Code : ",response.status);
                if(response.status === 200){
...
render(){
    ...
    let restImageData = <img  src="https://img.freepik.com/free-icon/user-filled-person-shape_318-74922.jpg?size=338c&ext=jpg" alt="logo" />
