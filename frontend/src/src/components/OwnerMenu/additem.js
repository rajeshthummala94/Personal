...
class AddItems extends Component{
   ...
   addItem=(details)=>{
    ...
    axios.post('http://localhost:3001/restaurant/additem',data)
        .then(response => {
    ...
    render(){
        let itemImageData = <img  src="https://img.freepik.com/free-icon/user-filled-person-shape_318-74922.jpg?size=338c&ext=jpg" alt="logo" />
